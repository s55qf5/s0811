...
<style lang="scss" scoped>
  ...
  .tables {
	& /deep/ .el-button--success {
		...
		border-width: 1px;
		border-style: solid;
		border-color: rgba(152, 129, 129, 1);
		border-radius: 4px;
